...
public interface Java7ParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link Java7Parser#typeTypeOrVoid}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTypeTypeOrVoid(Java7Parser.TypeTypeOrVoidContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Java7Parser#interfaceMethodModifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInterfaceMethodModifier(Java7Parser.InterfaceMethodModifierContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Java7Parser#integerLiteral}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIntegerLiteral(Java7Parser.IntegerLiteralContext ctx);
	/**
	 * Visit a parse tree produced by {@link Java7Parser#floatLiteral}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFloatLiteral(Java7Parser.FloatLiteralContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Java7Parser#localTypeDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLocalTypeDeclaration(Java7Parser.LocalTypeDeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Java7Parser#methodCall}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethodCall(Java7Parser.MethodCallContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Java7Parser#classType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassType(Java7Parser.ClassTypeContext ctx);
	/**
